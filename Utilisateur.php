...
<nav class="navbar navbar-expand-md">
	...
	<div class="collapse navbar-collapse" id="main-navigation">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="Achat">Achat</a></li> 
...
<h1>Ebay ECE !</h1>
<p>Vous êtes ? </p>
<a href="Acheteur.php"><button type="button" class="btn btn-light">Acheteur</button></a>
<a href="Vendeur.php"><button type="button" class="btn btn-light">Vendeur</button></a>
<a href="Administrateur.php"><button type="button" class="btn btn-light">Administrateur</button></a>

<p>Cliquez et identifiez vous !</p>
</div>
</header>
